...
function Navbar() {
    ...
    useEffect(() => {
        if (localStorage.getItem('Theme') === 'dark') { document.body.classList.add('dark'); document.body.classList.add('bg-darkBg') }
        else if (localStorage.getItem('Theme') == 'light') { document.body.classList.remove('dark'); document.body.classList.remove('bg-darkBg') }
        ...
        <div>
            <nav class="flex items-center justify-between flex-wrap p-6 lg:flow-root py-2 lg:pt-0 lg:py-4 relative bg-slate-100 dark:bg-darkBg dark:text-slate-100 align-center">
                ...
                <div class="flex items-center flex-shrink-0 relative h-10 lg:h-14 w-full">
                    ...
                    <div class="container">
                        <input type="text" class="hidden lg:block lg:relative mx-auto w-7/12 h-10 ps-4 bg-slate-100 text-black text-base border border-slate-500 focus:outline focus:outline-offset-0 outline-gray-950 rounded-sm dark:text-slate-100 dark:bg-darkBg dark:border-1" placeholder="Busca algo..."></input>
                    </div>
                ...
                <div class="w-full flex justify-center lg:flex lg:items-center lg:h-6 pt-1 dark:text-slate-300 text-gray-600">
                    <div class="hidden lg:block md:block md:w-auto lg:pl-2" id='Navlinks'>
                        <div class="lg:text-lg lg:flex-grow font-medium md:text-2xl text-xl">
                ...
                <div class="container flex justify-evenly text-gray-500 dark:text-slate-200 items-center">
                    ...
                    <input type="text" class="mt-1 mx-auto w-10/12 lg:hidden h-10 flex ps-4 text-black text-base border border-slate-500 focus:outline focus:outline-offset-0 outline-gray-950 rounded-md dark:bg-darkBg dark:text-slate-100 bg-slate-100" placeholder="Busca algo..."></input>
                    <Link to="/carrito">
